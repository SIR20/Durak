...
type
  Events = class
    private OList := new List<PictureWPF>;
  public
    event MouseDown, MouseUp, MouseEnter, MouseNEnter: procedure(o: PictureWPF);
...
OEvents = class
  private OList := new List<ObjectWPF>;
public
  event MouseDown, MouseUp, MouseEnter, MouseNEnter: procedure(o: ObjectWPF);
